        ...
        <>
            ...
            <div id="home-all">
                <div id="home-main">
                    ...
                    <p>It is still under heavy construction, but it is finally active and available to the world!</p>
                    <h3>About me</h3>
                    <p>I am a Senior at Florida Institute of Technology studying Computer Science (along with a Computational Mathematics Minor). I also do research with Dr. White and the <a href='https://research.fit.edu/nets/'>NEural TransmissonS</a> lab at Florida Tech.</p>
